...
namespace ReCapProject.Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public JwtSecurityToken CreateJwtSecurityToken(TokenOptions tokenOptions, User user, SigningCredentials signingCredentials, ICollection<OperationClaim> operationClaims)
        {
